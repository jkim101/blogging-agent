...
class SEOOptimizerAgent(BaseAgent):
    ...
    def run(self, state: dict[str, Any]) -> dict[str, Any]:
        ...
        if edited_ko:
            seo_ko, final_ko = self._optimize(edited_ko, outline, language="ko")
        ...
        if edited_en:
            seo_en, final_en = self._optimize(edited_en, outline, language="en")
    ...
    def _optimize(
        self, draft: str, outline, language: str
        ...
        seo_metadata = self.parse_tool_response(message, SEOMetadata)
